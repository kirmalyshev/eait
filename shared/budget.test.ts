...
const day = (kcal: number, o: { date?: string; meals?: number; target?: number; protein?: number } = {}) => ({
  date: o.date ?? TODAY,
  meals: Array.from({ length: o.meals ?? 1 }),
...
describe("dayBudget", () => {
  test("today under target: what is left, and the bar filled by what was eaten", () => {
    expect(dayBudget(day(1450, { protein: 80.4 }), TODAY, "lose")).toEqual({
      state: "left", kcal: 550, eaten: 1450, target: 2000, fill: 0.725, warn: false,
