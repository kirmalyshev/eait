...
const IT: WebCopy = {
  ...
  keptBehind: "Salvato su questo dispositivo. Partirà quando il messaggio qui sopra, che aspetta te, sarà stato inviato di nuovo o scartato.",
...
const RU: WebCopy = {
  ...
  composerPlaceholder: "Что ты ел?", send: "Отправить",
  ...
  refusals: {
    ...
    "target-gone": "Здесь нет открытого приёма пищи, который можно было бы изменить. Открой его в приложении или скажи, что ты ел, и запиши заново.",
