...
const FR: ChatCopy = {
  ...
  struggleCards: {
    ...
    binge: {
      ...
      body: "L'hyperphagie boulimique est le trouble alimentaire le plus fréquent — environ 2,8 % des adultes en remplissent les critères à un moment, et 17 % des personnes qui démarrent un programme de gestion du poids ont un dépistage positif. Si les crises semblent hors de contrôle, un professionnel de santé t'aidera plus que n'importe quelle appli. Ici, une journée difficile est une donnée, jamais un verdict.",
      source: "NIMH (NCS-R) · étude sur 6 930 personnes débutant un programme",
    },
    diets: {
      title: "Reprendre du poids, c'est la norme — pas ta faute",
      body: "Sur 29 études au long cours, plus de la moitié du poids perdu revient en deux ans — plus de 80 % au bout de cinq. Ce sont les méthodes qui échouent, pas les gens. Ici, ton plan est pensé pour durer, pas pour impressionner.",
  ...
  dietsGainCard: {
    title: "Reprendre du poids, c'est la norme — pas ta faute",
    body: "La plupart des tentatives de changer de poids, dans un sens comme dans l'autre, finissent par s'effacer en quelques années — les méthodes échouent, pas les gens. Ici, ton surplus est pensé pour durer, pas pour impressionner.",
  },
  gainPaceCard: {
