...
/**
 * A MEAL WHOSE NUMBERS ARE A GUESS (#28) — the one definition, read by every surface that prints
 * one of its figures.
 *
...
export interface DayBudget {
  ...
  fill: number;
  /**
   * The day has a guessed meal in it, so every figure derived from it is a guess (#28).
   *
