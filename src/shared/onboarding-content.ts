...
const DE: OnboardingContent = {
  ...
  screens: [
    ...
    },
    {
      ...
      asks: {
        ...
        weight_kg: {
          lines: ["Und dein Gewicht jetzt, in kg? Die eait-App fürs iPhone hält es über Apple Health aktuell."],
  ...
  summary: {
    ...
    projection: "In diesem Tempo wärst du um {month} bei {target} kg.",
...
const RU: OnboardingContent = {
  ...
  summary: {
    ...
    projection: "В таком темпе ты будешь на {target} кг примерно к {month}.",
