 ...
 *
 * The camera's pending state (the photos two to a row, Spud's line and the empty card — #607) is
 * on screen only between Analyze and the card, about a second against this analyzer, and an
