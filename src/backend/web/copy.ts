...
const FR: PageCopy = {
  ...
  belowHealthyTarget: "L'objectif le plus bas que nous puissions planifier à ta taille est {kg} kg.",
...
const IT: PageCopy = {
  ...
  chatNoFocusCorrection: "Qui non c'è nessun pasto aperto da correggere. Aprilo nell'app, oppure dì cosa hai mangiato e registralo di nuovo.",
...
const ES: PageCopy = {
  ...
  chatRefusalNetwork: "Demasiadas desde esta red — no eres tú, es esta conexión. Inténtalo más tarde.",
  ...
  chatNoFocusCorrection: "Aquí no hay ninguna comida abierta que corregir. Ábrela en la app, o di qué comiste y regístralo otra vez.",
...
const VI: PageCopy = {
  ...
  chatTooMany: "Nhiều góc chụp hơn mức một bữa ăn có thể có.",
  ...
  ageBelowMinimum: "Chúng mình chỉ lên kế hoạch cho người trưởng thành — kiểm tra lại năm nhé.",
...
const ID: PageCopy = {
  ...
  chatExpired: "Yang itu sudah tidak ditahan lagi. Sebutkan sekali lagi.",
  ...
  chatRefusalSubscription: "Analisis yang datang bersama akun ini sudah habis. Berlangganan untuk melanjutkan.",
  chatRefusalFailed: "Tidak ada yang kembali. Coba lagi.",
  ...
  chatTooMany: "Itu lebih banyak sudut daripada yang bisa dimiliki satu makanan.",
  chatTooLarge: "Foto itu terlalu besar untuk dikirim.",
  chatPhotoLead: "Atau fotokan saja",
  ...
  pairLead: "Sebuah kode memasukkan peramban ini ke akun yang membuatnya. Berlaku sekali, dan hanya selama lima menit.",
  pairLabel: "Kode penyambungmu",
  pairButton: "Sambungkan peramban ini",
  errorPair: "Kode itu tidak berhasil. Sebuah kode berlaku sekali, dan hanya lima menit setelah dibuat.",
...
const RU: PageCopy = {
  ...
  chatNoFocusCorrection: "Здесь нет открытого приёма пищи, который можно было бы поправить. Открой его в приложении или скажи, что ты ел, и запиши заново.",
