...
const ID: TelegramCopy = {
  ...
  refusals: {
    ...
    "subscription-required": "Analisis yang datang bersama akun ini sudah habis. Berlangganan di web untuk melanjutkan.",
...
const RU: TelegramCopy = {
  ...
  viaApp: "приложение",
  connectedTail: "Пришли фото еды, расскажи, что ты ел, или задай вопрос Gabie.",
  ...
  updated: "Обновил.",
  moved: "Перенёс.",
  targetGone: "Здесь нет открытого приёма пищи, который можно было бы изменить. Скажи, что ты ел, и запиши заново.",
